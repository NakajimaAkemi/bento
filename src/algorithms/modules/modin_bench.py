...
class ModinBench(AbstractAlgorithm):
    ...
    def restore(self):
        ...
        """
        self.df_ = self.backup_.copy(deep=True)

    def get_pandas_df(self):
        """
        Returns the internal dataframe as a pandas dataframe
        """
        return self.df_._to_pandas()
    ...
    def read_sql(self, query, conn, **kwargs):
        ...
        """
        self.df_ = pd.read_sql(query, conn, **kwargs)
        return self.df_
    ...
    def delete_columns(self, columns):
        ...
        Columns is a list of column names
        """
        self.df_ = self.df_.drop(columns=columns, inplace=False)
        return self.df_
    ...
    def to_parquet(self, path="./pipeline_output/modin_output.parquet", **kwargs):
        ...
        """
        self.df_.to_parquet(f"./pipeline_output/{self.name}_output.parquet", **kwargs)
